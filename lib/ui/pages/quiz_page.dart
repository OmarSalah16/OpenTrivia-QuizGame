...
import 'package:open_trivia/ui/pages/quiz_finished.dart';
                  ...
                  (
                    ...
                    (
                      ...
                      (
                        ...
                        child: Text
                        (
                          _currentIndex == (widget.questions.length - 1) ? "Submit" : "Next", style: MediaQuery.of(context).size.width > 800 ? const TextStyle(fontSize: 30.0) : null
                        ),
